...
import logging
from infoane.status_code import field_cannot_be_blank, field_list_cannot_be_empty, field_required_error, field_should_be_boolean_type, \
    field_should_be_int_type, field_should_be_list_type, field_should_be_string_type, table_not_exist
from infoane.consts import STATUS_ACTIVE
from infoane.helpers.custom_helpers import CustomExceptionHandler, int_float_check
    ...
    def run_validation(self, data=empty):
        ...
        if not getattr(self.root, "partial", False):
            ...
            if not isinstance(data, str):
                ...
                data = data.strip() if self.store_lower else data.strip()
