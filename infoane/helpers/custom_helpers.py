import logging
from infoane.status_code import *
...
def help_text_for_list_dict(value):
    """_summary_
    ...
    if isinstance(value, list):
        return f'Enter value from this list - {value}'
    elif isinstance(value, dict):
        return f'Enter value from this list - {list(value.keys())}'
    else:
        raise CustomExceptionHandler(generic_error_2)
