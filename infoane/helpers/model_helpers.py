...
from infoane.helpers.custom_helpers import CustomExceptionHandler
from infoane.consts import STATUS_ACTIVE, CREATION_BY
from django.db import models
from infoane.status_code import invalid_log_model, error_while_log_table_saving
from infoane.middleware.auth import get_request
...
class AddCommonField(models.Model):
    ...
    other = models.CharField(max_length=100, null=True, default="")
